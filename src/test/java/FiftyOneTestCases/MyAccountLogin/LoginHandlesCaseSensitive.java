...
public class LoginHandlesCaseSensitive {
	WebDriver driver;
	...
	public void clickOnMyAccount() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id='username']")).sendKeys("Anooo@hotmail.co.thhh");
		driver.findElement(By.xpath("//*[@id='password']")).sendKeys("anotestcase51111");
		Thread.sleep(3000);
