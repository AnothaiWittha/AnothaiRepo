...
public class LoginWithIncorrectUsernameAndPassword {
	WebDriver driver;
	...
	public void clickOnMyAccount() throws InterruptedException {
		...
		driver.findElement(By.xpath("//*[@id='username']")).sendKeys("thisisemail@hoho");
		driver.findElement(By.xpath("//*[@id='password']")).sendKeys("helooow");
		Thread.sleep(3000);
