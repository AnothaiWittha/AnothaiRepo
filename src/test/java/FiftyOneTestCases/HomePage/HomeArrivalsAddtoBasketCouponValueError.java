...
public class HomeArrivalsAddtoBasketCouponValueError {
	/*
	 1) Open the browser 
	...
	because the coupon is applicable for the book price > 450 rp*/
	...
	@Test(priority = 6)
	public void enterCouponError() throws InterruptedException {
		...
		String sendingString = "450.00";
		 
	    String actualResultOnthePage =
	                driver.findElement(By.xpath("//*[@id=\"page-34\"]/div/div[1]/ul")).getText();
	        
	    Assert.assertTrue(actualResultOnthePage.contains(sendingString));
	    System.out.println("User see message The minimum spend for this coupon is ₹450.00.");
