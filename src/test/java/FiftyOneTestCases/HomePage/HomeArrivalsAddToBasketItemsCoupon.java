...
public class HomeArrivalsAddToBasketItemsCoupon {
	/*
 	1) Open the browser
	...
	@Test(priority = 6)
	public void enterCoupon() throws InterruptedException {
		...
		System.out.println("User can able to apply coupon by entering ‘krishnasakinala’");
