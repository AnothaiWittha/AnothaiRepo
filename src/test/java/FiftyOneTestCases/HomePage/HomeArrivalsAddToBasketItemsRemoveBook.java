...
public class HomeArrivalsAddToBasketItemsRemoveBook {
	...
	@Test(priority = 6)
	public void removerThisIcon() throws InterruptedException {
		...
		driver.navigate().refresh();
		System.out.println("User has the feasibility to remove the book");
	}
